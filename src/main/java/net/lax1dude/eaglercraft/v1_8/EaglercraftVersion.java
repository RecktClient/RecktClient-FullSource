...
public class EaglercraftVersion {
	...
	public static final String projectForkName = "RecktClient";
	public static final String projectForkVersion = "v1.0";
	public static final String projectForkVendor = "wasd.isgoose";

	public static final String projectForkURL = "https://discord.gg/recktclient";
	...
	public static final String mainMenuStringB = "RecktClient v1.0 | made by wasd.isgoose on discord [" + EagRuntime.getPlatformType().getName() + "]";
	public static final String mainMenuStringC = "";
	public static final String mainMenuStringD = "Resources Copyright Mojang AB";

	public static final String mainMenuStringE = "RecktClient v1.0";
	public static final String mainMenuStringF = "Made by wasd.isgoose on discord";

	public static final String mainMenuStringG = "Collector's Edition";
	public static final String mainMenuStringH = "PBR Shaders";

	public static final String screenRecordingFilePrefix = "RecktClient-1.8";
